...
const allMoviesOverTwoMinutes = songs.every((song) => song.runtimeInSeconds > 120)
return allMoviesOverTwoMinutes
}
...
const allSongsOverFourMinutes = songs.some((song) => song.runtimeInSeconds > 240)
return allSongsOverFourMinutes
}
...
function anySongIsByPeanut(songs) {
  const allSongsByPeanut = songs.some((song) => song.artist === "Peanut")
  return allSongsByPeanut
}
