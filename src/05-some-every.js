 ...
 * @returns {boolean}
 */
const allSongsAreOverTwoMinutes = (songs) => songs.every(song => song.runtimeInSeconds / 60 > 2);
 ...
 * @returns {boolean}
 */
const anySongIsOverFourMinutes = (songs) => songs.some(song => song.runtimeInSeconds / 60 > 4);
