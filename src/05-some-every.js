 ...
 * @returns {boolean}
 */
const allSongsAreOverTwoMinutes = songs => {return songs.every(song => song.runtimeInSeconds > 120)}
 ...
 * @returns {boolean}
 */
const anySongIsOverFourMinutes = songs => {return songs.some(song => song.runtimeInSeconds > 240)}
 ...
 * @returns {boolean}
 */
const anySongIsByPeanut  = songs => {return songs.some(song => song.artist === "Peanut")}
