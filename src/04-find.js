 ...
 */
const findPinkElephantsByTimestreet = songs =>  {return songs.find(song => song.title === "Pink Elephants")}
 ...
 * @returns {Object} A single object.
 */
const findFirstSongUnderThreeMinutes = songs => {return songs.find(song => song.runtimeInSeconds < 180)}
 ...
 * @returns {Object} A single object.
 */
const findFirstTitleTrack = songs => {return songs.find(song => song.title == song.album)}
